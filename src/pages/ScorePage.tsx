...
export default function ScorePage() {
  ...
  const barColors = ['hsl(var(--accent))', 'hsl(var(--success))', 'hsl(var(--warning))', 'hsl(var(--info))', 'hsl(var(--destructive))', 'hsl(173 58% 49%)', 'hsl(222 47% 25%)', 'hsl(38 70% 55%)', 'hsl(160 40% 50%)'];
